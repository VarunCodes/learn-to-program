  ...
  if write > 0 
    if write == 1
      ...
      if left == 0 
        ...
        num_string = num string + "eleven"
      elsif left == 2 
        num_string = num string + "twelve"
      elsif left == 3 
        num_string = num string + "thriteen"
      elsif left == 4 
        num_string = num string + "fourtneed"
      elsif left == 5 
        num_string = num string + "fifteen"
      elsif left == 6 
        num_string = num string + "sixteen"
      elsif left == 7 
        num_string = num string + "seventeen"
      elsif left == 8 
        num_string = num string + "eighteen"
      elsif left == 9 
        num_string = num string + "nineteen"
      end
